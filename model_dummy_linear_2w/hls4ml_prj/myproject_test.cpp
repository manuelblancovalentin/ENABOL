...
//      if (e % CHECKPOINT == 0) std::cout << "Processing input " << e << std::endl;
      ...
      result_t ground_truth_layer3_out[N_LAYER_2];

      for (int i = 0; i < N_LAYER_2; i++) {
            ground_truth_layer3_out[i] = static_cast<result_t>(pr[i]);
      }

      //hls-fpga-machine-learning insert top-level-function
      unsigned short size_in1,size_out1;
      myproject(fc1_input,layer3_out, loss_layer3_out,size_in1,size_out1, ground_truth_layer3_out, train);
      flosses << loss_layer3_out << "\n";
      ...
      if (e % CHECKPOINT == 0) {
        ...
        printf(" %.10s |", loss_layer3_out.to_string(10, true).c_str());
