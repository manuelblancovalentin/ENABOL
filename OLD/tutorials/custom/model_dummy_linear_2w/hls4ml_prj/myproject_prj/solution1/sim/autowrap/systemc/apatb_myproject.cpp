...
extern ap_fixed<6, 1, (ap_q_mode) 5, (ap_o_mode)3, 0> w4[2];
...
// wrapc file define: "loss_layer5_out_V"
#define AUTOTB_TVOUT_loss_layer5_out_V  "../tv/cdatafile/c.myproject.autotvout_loss_layer5_out_V.dat"
...
// wrapc file define: "layer5_out_ground_truth_V"
#define AUTOTB_TVIN_layer5_out_ground_truth_V  "../tv/cdatafile/c.myproject.autotvin_layer5_out_ground_truth_V.dat"
...
// tvout file define: "loss_layer5_out_V"
#define AUTOTB_TVOUT_PC_loss_layer5_out_V  "../tv/rtldatafile/rtl.myproject.autotvout_loss_layer5_out_V.dat"
...
class INTER_TCL_FILE {
	public:
		INTER_TCL_FILE(const char* name) {
			...
			loss_layer5_out_V_depth = 0;
			const_size_in_1_depth = 0;
			const_size_out_1_depth = 0;
			layer5_out_ground_truth_V_depth = 0;
			train_depth = 0;
			trans_num =0;
		}
		...
		string get_depth_list () {
			...
			total_list << "{loss_layer5_out_V " << loss_layer5_out_V_depth << "}\n";
			total_list << "{const_size_in_1 " << const_size_in_1_depth << "}\n";
			total_list << "{const_size_out_1 " << const_size_out_1_depth << "}\n";
			total_list << "{layer5_out_ground_truth_V " << layer5_out_ground_truth_V_depth << "}\n";
	...
	public:
		...
		int loss_layer5_out_V_depth;
		int const_size_in_1_depth;
		int const_size_out_1_depth;
		int layer5_out_ground_truth_V_depth;
		int train_depth;
		int trans_num;
...
ap_fixed<16, 6, (ap_q_mode) 0, (ap_o_mode)0, 0> layer5_out[1],
ap_fixed<16, 6, (ap_q_mode) 0, (ap_o_mode)0, 0> (&loss_layer5_out),
unsigned short (&const_size_in_1),
unsigned short (&const_size_out_1),
ap_fixed<16, 6, (ap_q_mode) 0, (ap_o_mode)0, 0> layer5_out_ground_truth[1],
bool train);
...
bool train)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		// output port post check: "loss_layer5_out_V"
		aesl_fh.read(AUTOTB_TVOUT_PC_loss_layer5_out_V, AESL_token); // [[transaction]]
		if (AESL_token != "[[transaction]]")
		{
			exit(1);
		}
		aesl_fh.read(AUTOTB_TVOUT_PC_loss_layer5_out_V, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(AUTOTB_TVOUT_PC_loss_layer5_out_V, AESL_token); // data

			sc_bv<16> *loss_layer5_out_V_pc_buffer = new sc_bv<16>[1];
			int i = 0;
			...
			while (AESL_token != "[[/transaction]]")
			{
				...
				while (!no_x)
				{
					...
					if (x_found != string::npos)
					{
						if (!err)
						{
							cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'X' on port 'loss_layer5_out_V', possible cause: There are uninitialized variables in the C design." << endl;
							err = true;
						}
						AESL_token.replace(x_found, 1, "0");
					}
				...
				if (AESL_token != "")
				{
					loss_layer5_out_V_pc_buffer[i] = AESL_token.c_str();
					i++;
				}

				aesl_fh.read(AUTOTB_TVOUT_PC_loss_layer5_out_V, AESL_token); // data or [[/transaction]]

				if (AESL_token == "[[[/runtime]]]" || aesl_fh.eof(AUTOTB_TVOUT_PC_loss_layer5_out_V))
				{
					exit(1);
				}
			}
			...
			if (i > 0)
			{
				// RTL Name: loss_layer5_out_V
				{
					// bitslice(15, 0)
					// {
						// celement: loss_layer5_out.V(15, 0)
						// {
							sc_lv<16>* loss_layer5_out_V_lv0_0_0_1 = new sc_lv<16>[1];
						// }
					// }
					...
					// bitslice(15, 0)
					{
						...
						// celement: loss_layer5_out.V(15, 0)
						{
							...
							{
								if (&(loss_layer5_out) != NULL) // check the null address if the c port is array or others
								{
									loss_layer5_out_V_lv0_0_0_1[hls_map_index].range(15, 0) = sc_bv<16>(loss_layer5_out_V_pc_buffer[hls_map_index].range(15, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(15, 0)
					{
						...
						// celement: loss_layer5_out.V(15, 0)
						{
							...
							{
								// sub                    : i_0
								// ori_name               : loss_layer5_out
								// sub_1st_elem           : 0
								// ori_name_1st_elem      : loss_layer5_out
								// output_left_conversion : (loss_layer5_out).range()
								// output_type_conversion : (loss_layer5_out_V_lv0_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
								if (&(loss_layer5_out) != NULL) // check the null address if the c port is array or others
								{
									(loss_layer5_out).range() = (loss_layer5_out_V_lv0_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
									hls_map_index++;
								}
							}
						}
			...
			// release memory allocation
			delete [] loss_layer5_out_V_pc_buffer;
		}
	...
	else
	{
		...
		// "loss_layer5_out_V"
		char* tvout_loss_layer5_out_V = new char[50];
		aesl_fh.touch(AUTOTB_TVOUT_loss_layer5_out_V);
		...
		// "layer5_out_ground_truth_V"
		char* tvin_layer5_out_ground_truth_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_layer5_out_ground_truth_V);
		...
		// [[transaction]]
		sprintf(tvin_layer5_out_ground_truth_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_layer5_out_ground_truth_V, tvin_layer5_out_ground_truth_V);

		sc_bv<16>* layer5_out_ground_truth_V_tvin_wrapc_buffer = new sc_bv<16>[1];

		// RTL Name: layer5_out_ground_truth_V
		{
			// bitslice(15, 0)
			{
				int hls_map_index = 0;
				// celement: layer5_out_ground_truth.V(15, 0)
				{
					// carray: (0) => (0) @ (1)
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						// sub                   : i_0
						// ori_name              : layer5_out_ground_truth[i_0]
						// sub_1st_elem          : 0
						// ori_name_1st_elem     : layer5_out_ground_truth[0]
						// regulate_c_name       : layer5_out_ground_truth_V
						// input_type_conversion : (layer5_out_ground_truth[i_0]).range().to_string(SC_BIN).c_str()
						if (&(layer5_out_ground_truth[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<16> layer5_out_ground_truth_V_tmp_mem;
							layer5_out_ground_truth_V_tmp_mem = (layer5_out_ground_truth[i_0]).range().to_string(SC_BIN).c_str();
							layer5_out_ground_truth_V_tvin_wrapc_buffer[hls_map_index].range(15, 0) = layer5_out_ground_truth_V_tmp_mem.range(15, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_layer5_out_ground_truth_V, "%s\n", (layer5_out_ground_truth_V_tvin_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_layer5_out_ground_truth_V, tvin_layer5_out_ground_truth_V);
		}

		tcl_file.set_num(1, &tcl_file.layer5_out_ground_truth_V_depth);
		sprintf(tvin_layer5_out_ground_truth_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_layer5_out_ground_truth_V, tvin_layer5_out_ground_truth_V);

		// release memory allocation
		delete [] layer5_out_ground_truth_V_tvin_wrapc_buffer;
...
// [call_c_dut] ---------->
		...
		myproject(fc1_input, layer5_out, loss_layer5_out, const_size_in_1, const_size_out_1, layer5_out_ground_truth, train);
		...
		// [[transaction]]
		sprintf(tvout_loss_layer5_out_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVOUT_loss_layer5_out_V, tvout_loss_layer5_out_V);

		sc_bv<16>* loss_layer5_out_V_tvout_wrapc_buffer = new sc_bv<16>[1];
			...
			// bitslice(15, 0)
			{
				...
				// celement: loss_layer5_out.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 1)
					{
						...
						// sub_1st_elem          : 0
						// ori_name_1st_elem     : loss_layer5_out
						// regulate_c_name       : loss_layer5_out_V
						// input_type_conversion : (loss_layer5_out).range().to_string(SC_BIN).c_str()
						if (&(loss_layer5_out) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<16> loss_layer5_out_V_tmp_mem;
							loss_layer5_out_V_tmp_mem = (loss_layer5_out).range().to_string(SC_BIN).c_str();
							loss_layer5_out_V_tvout_wrapc_buffer[hls_map_index].range(15, 0) = loss_layer5_out_V_tmp_mem.range(15, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvout_loss_layer5_out_V, "%s\n", (loss_layer5_out_V_tvout_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVOUT_loss_layer5_out_V, tvout_loss_layer5_out_V);
		}

		tcl_file.set_num(1, &tcl_file.loss_layer5_out_V_depth);
		sprintf(tvout_loss_layer5_out_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVOUT_loss_layer5_out_V, tvout_loss_layer5_out_V);

		// release memory allocation
		delete [] loss_layer5_out_V_tvout_wrapc_buffer;
		...
		// release memory allocation: "loss_layer5_out_V"
		delete [] tvout_loss_layer5_out_V;
		...
		// release memory allocation: "layer5_out_ground_truth_V"
		delete [] tvin_layer5_out_ground_truth_V;
